...
object TaxiApplication extends App {
  ...
  //  pickupsByBoroughDF.show() // Data is skewed towards Manhattan
  ...
  // Question 3 - how are trips distributed by length
  ...
  // Question 4 - What are peak hours for long / short trips?
  ...
  // Q 5 - top 3 pickup/dropoff zones for long/short trips?
  ...
  //  Q6) - How are people paying for the ride, on long/short trips?
  ...
  //  Q7) - How is the payment type evolving with time? i.e date vs payment method
  ...
  //  Q8) - Can we explore a ride-sharing opportunity by grouping close short trips?
