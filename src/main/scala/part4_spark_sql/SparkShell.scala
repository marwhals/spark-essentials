...
/*
  - Note: Overlap of Spark SQL section
  - Consider changing to markdown file
 */
   ...
   *
   * Previously discussed: there is no difference between Spark SQL tables and DataFrames from Spark's point of view.
   ...
   *   - tables can be accessed in Spark SQL in the context of a database (which is just a form (way?) of organizing them)
   */
// ---------------------------
  /**
   * Commands from previous lecture.:
   *
   ...
   *
   * // show the database you're using
   ...
   * insert into persons values (1, "John Doe"), (2, "Bob Doe")
   *
...
//----------------------------
  /**
   *
   * A VERY important distinction is the difference between a MANAGED vs an EXTERNAL table.
