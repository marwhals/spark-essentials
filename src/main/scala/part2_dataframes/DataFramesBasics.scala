...
/**
 * - Creating a SparkSession allows for the creating, reading and writing DataFrames
 * - When reading a DataFrame from a file
 * ---- Rows = unstructured data
 * ---- Schema = description of fields aka columns and their type
 * - Spark Types ---- Known at runtime and not compile time
 */


object DataFramesBasics extends App {

  // creating a SparkSession -- Allows for creating, reading and writing DataFrames
  ...
  // showing a DF
  firstDF.show()
  firstDF.printSchema() //Description of every column in the DataFrame

  // get rows
  firstDF.take(10).foreach(println)

  // spark types
  val longType = LongType // Spark specific types
  ...
  val smartphones =  Seq(
    ("Samsung", "Galaxy S12", "Android", 13),
    ("Apple", "Galaxy S12", "Android", 13),
    ("Nokia", "3310", ".....", 0) //TODO see how to deal with null types
  )
